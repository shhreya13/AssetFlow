    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 space-y-8">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-dark">AssetFlow</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-primary hover:bg-secondary text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02]"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="text-center text-sm text-gray-500">
          <p>Demo: admin@assetflow.com / password123</p>
        </div>
      </div>
    </div>
  );
